...
RUN R -q -e "BiocManager::install(version='3.20', ask=FALSE); BiocManager::install(c('sesame','sesameData','SummarizedExperiment','limma','DMRcate','DMRcatedata','EPICv2manifest','IlluminaHumanMethylationEPICv2anno.20a1.hg38'), ask=FALSE, update=FALSE)" \
